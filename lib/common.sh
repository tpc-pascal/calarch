...
INSTALL_MODE='${INSTALL_MODE:-disk}'
INSTALL_DISK='${INSTALL_DISK:-}'
INSTALL_ESP='${INSTALL_ESP:-}'
INSTALL_ROOT='${INSTALL_ROOT:-}'
INSTALL_SWAP='${INSTALL_SWAP:-}'
USE_SWAPFILE=${USE_SWAPFILE:-0}
INSTALL_SWAPFILE='${INSTALL_SWAPFILE:-}'
SWAPFILE_SIZE_MB=${SWAPFILE_SIZE_MB:-8192}
KERNEL_PARAMS='${KERNEL_PARAMS:-nowatchdog processor.max_cstate=4 intel_idle.max_cstate=4 i915.enable_fbc=1 i915.enable_psr=1 i915.enable_rc6=1 i915.fastboot=1 mitigations=off pcie_aspm=force}'
